...
var load = function() {
	console.log("##CLI: /load start..")
    if(!editing) {
		console.log("##CLI: GET /load start..")
		$.get('/load', function (data) {
			...
			$(data).each(function (i) {
				...
				$("#wall .item:first .del").click(function(evt) {
					console.log("CLI: del id=" + id);
					del(id);
				});
					
				$("#wall .item:first .like").click(function(evt) {
					editing = false;
					console.log("CLI: like id=" + id);
					like(id);
				});
				
			});
		});	
		console.log("##CLI: GET /load end..")
	}
	console.log("##CLI: /load end..")
};
